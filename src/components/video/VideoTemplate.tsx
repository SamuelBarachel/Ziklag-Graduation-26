...
export default function VideoTemplate() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#FFFBF0] text-[#1a1200]">
      <audio
        ref={audioRef}
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        />
        <motion.div
          className="absolute w-[600px] h-[600px] rounded-full opacity-8 blur-[80px]"
          style={{ background: 'radial-gradient(circle, #f5d76e, transparent)' }}
      ...
      <AnimatePresence>
        {recording && (
          <motion.div
            className="absolute top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-full bg-white/90 border border-red-400/60 px-4 py-2 shadow-lg"
          ...
          >
            ...
            />
            <span className="text-xs font-semibold uppercase tracking-widest text-[#1a1200]">
        ...
        {recordingDone && (
          <motion.div
            className="absolute top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-full bg-white/90 border border-[#d4af37]/60 px-4 py-2 shadow-lg"
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
          >
            <span className="text-xs font-semibold uppercase tracking-widest text-[#1a1200]">
      ...
      <AnimatePresence>
        {!started && (
          <motion.div
            ...
            style={{ background: 'rgba(255,251,240,0.96)', backdropFilter: 'blur(6px)' }}
            initial={{ opacity: 1 }}
            exit={{ opacity: 0, transition: { duration: 1.2, ease: 'easeInOut' } }}
          >
            <motion.p
              className="font-body text-base sm:text-[1.2vw] tracking-[0.3em] uppercase text-[#b8860b] mb-4"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.h1
              className="font-display text-2xl sm:text-[4vw] text-[#1a1200] font-bold tracking-wide text-center mb-10"
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.button
              ...
              style={{ border: '2px solid #d4af37', background: 'rgba(212,175,55,0.12)' }}
            ...
            >
              ...
              />
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#b8860b">
                <polygon points="6,3 20,12 6,21" />
              </svg>
            </motion.button>

            <motion.p
              className="mt-6 font-body text-xs sm:text-[0.85vw] text-[#7a5c1e]/60 tracking-widest uppercase"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {canRecord && (
              ...
              >
                <div className="h-[1px] w-[20vw] bg-gradient-to-r from-transparent via-[#d4af37]/40 to-transparent mb-2" />
                <button
                  onClick={handleRecordAndExport}
                  className="inline-flex items-center gap-2 rounded-full border border-[#d4af37]/70 bg-[#d4af37]/10 px-6 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-[#7a5c1e] transition hover:bg-[#d4af37]/20 focus:outline-none"
                >
