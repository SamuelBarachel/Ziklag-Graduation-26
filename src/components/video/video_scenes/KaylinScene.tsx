...
export function KaylinScene() {
  ...
  return (
    ...
    >
      ...
      {/* Photo area — between bars, no overlap with text */}
      ...
      <div className="flex-1 flex flex-row items-center justify-center gap-[2vw] px-6 overflow-hidden">
        ...
        >
          ...
          >
            <img src={`${import.meta.env.BASE_URL}photos/kaylin_solo.jpeg`} alt="Kaylin Solo" className="w-full h-full object-cover" />
      ...
      {/* Text strip — always below photos, never overlapping */}
