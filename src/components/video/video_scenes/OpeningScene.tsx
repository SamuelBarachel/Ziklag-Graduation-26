  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-4 px-8">
        <motion.p
          className="text-xs tracking-[0.5em] uppercase text-[#d4af37]/80 font-body"
        ...
        <motion.h1
          className="font-display font-bold text-[#d4af37] tracking-wider leading-tight"
        ...
        <motion.p
          className="font-display text-[#fff8e7]/80 tracking-[0.3em] uppercase"
