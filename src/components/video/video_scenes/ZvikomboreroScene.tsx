  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center gap-6 w-full px-8">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_2.jpeg`} alt="Zvikomborero" className="w-full h-full object-contain" />
        </motion.div>
        ...
        >
          ...
          >
            <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_solo.jpeg`} alt="Zvikomborero Solo" className="w-full h-full object-contain rounded-sm shadow-2xl" />
        ...
        <motion.div
          ...
          style={{ perspective: 600 }}
        >
          <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_3.jpeg`} alt="Zvikomborero" className="w-full h-full object-contain" />
        </motion.div>
      </div>

      {/* Name + Degree */}
      <div className="mt-8 text-center w-full max-w-4xl mx-auto px-8">
        <motion.div
