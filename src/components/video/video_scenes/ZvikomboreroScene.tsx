...
export function ZvikomboreroScene() {
  ...
  return (
    <motion.div
      className="absolute inset-0 bg-[#0a0f2e] flex flex-col overflow-hidden"
    ...
    >
      ...
      <div className="flex-1 flex flex-row items-center justify-center gap-[2vw] px-6 overflow-hidden">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_2.jpeg`} alt="Zvikomborero" className="w-full h-full object-cover" />
        </motion.div>
        ...
        >
          <motion.div
            className="w-full h-full relative bg-[#0a0f2e] rounded-sm overflow-hidden"
            initial={{ clipPath: 'circle(0% at 50% 50%)' }}
            animate={phase >= 1 ? { clipPath: 'circle(150% at 50% 50%)' } : { clipPath: 'circle(0% at 50% 50%)' }}
            transition={{ duration: 1.8, ease: [0.16, 1, 0.3, 1] }}
          >
            <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_solo.jpeg`} alt="Zvikomborero Solo" className="w-full h-full object-cover" />
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/zvikomborero_3.jpeg`} alt="Zvikomborero" className="w-full h-full object-cover" />
        </motion.div>
      </div>

      <div className="h-[28vh] bg-gradient-to-t from-[#020812] to-[#060d24] flex flex-col items-center justify-center px-8 flex-shrink-0">
        <motion.div
        ...
        <h2 className="font-display text-2xl sm:text-[3.2vw] text-[#f5e6a3] font-semibold tracking-wide leading-tight text-center">
          {'Brother Zvikomborero Mziti'.split(' ').map((word, i) => (
