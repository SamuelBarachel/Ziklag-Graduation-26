  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center gap-6 w-full px-8">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/kudakwashe_2.jpeg`} alt="Kudakwashe" className="w-full h-full object-contain" />
        </motion.div>
        ...
        >
          ...
          >
            <img src={`${import.meta.env.BASE_URL}photos/kudakwashe_solo.jpeg`} alt="Kudakwashe Solo" className="w-full h-full object-contain rounded-sm shadow-2xl" />
        ...
        <motion.div
          ...
          style={{ perspective: 600 }}
        >
          <img src={`${import.meta.env.BASE_URL}photos/kudakwashe_3.jpeg`} alt="Kudakwashe" className="w-full h-full object-contain" />
        </motion.div>
      </div>
