  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-row items-center justify-center gap-[2vw] px-6 overflow-hidden">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/rumbidzai_3.jpeg`} alt="Rumbidzai" className="w-full h-full object-cover" />
        </motion.div>
      </div>
      ...
      <div className="h-[28vh] bg-gradient-to-t from-[#FFF3C4] to-[#FFFBF0] flex flex-col items-center justify-center px-8 flex-shrink-0" style={{ zIndex: 15, position: 'relative' }}>
        <motion.div
          className="h-[1px] mx-auto mb-2 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent"
          initial={{ width: 0 }}
          animate={phase >= 2 ? { width: '60%' } : { width: 0 }}
          transition={{ duration: 1, ease: 'easeOut', delay: 0.2 }}
        />
        <h2 className="font-display text-[#1a1200] font-semibold tracking-wide leading-tight text-center" style={{ fontSize: 'clamp(1.1rem, 2.2vw, 2.4rem)' }}>
            ...
            <span key={i} className="mr-[0.5vw]">
              {word.split('').map((char, j) => (
                <motion.span key={j} className="inline-block"
                  ...
                  transition={{ duration: 0.6, delay: phase >= 2 ? i * 0.13 + j * 0.018 : 0 }}
                >{char}</motion.span>
              ))}
            </span>
          ))}
        ...
        <motion.p
          className="mt-2 font-body text-xs sm:text-[1.1vw] text-[#7a5c1e] tracking-[0.15em] uppercase"
        ...
        <motion.p
          className="mt-1 font-body text-xs sm:text-[0.9vw] text-[#b8860b]/80 tracking-[0.12em] uppercase"
        ...
        <motion.p
          className="mt-1 font-body text-[11px] sm:text-[0.8vw] text-[#b8860b] tracking-[0.3em] uppercase"
          initial={{ opacity: 0 }}
        ...
        <motion.div
          className="h-[1px] mx-auto mt-2 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent"
          initial={{ width: 0 }}
