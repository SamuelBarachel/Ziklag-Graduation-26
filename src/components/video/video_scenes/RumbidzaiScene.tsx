    ...
    >
      ...
      <div className="flex flex-row items-center justify-center gap-6 w-full px-8">
        ...
        >
          ...
          >
            <img src={`${import.meta.env.BASE_URL}photos/rumbidzai_solo.jpeg`} alt="Rumbidzai Solo" className="w-full h-full object-contain rounded-sm shadow-2xl" />
        ...
        >
          <img src={`${import.meta.env.BASE_URL}photos/rumbidzai_2.jpeg`} alt="Rumbidzai" className="w-full h-full object-contain" />
        </motion.div>
      </div>
